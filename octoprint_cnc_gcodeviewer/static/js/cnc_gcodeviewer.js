    ...
    function GcodeViewModel(parameters) {
        ...
        self.initialize = function () {
            self.sizeThresholdStr = sizeObservable(
                self.settings.settings.plugins.cnc_gcodeviewer.sizeThreshold
            );
        ...
        self.showGCodeViewer = function (response, rstatus) {
            // Slice of the gcode
            var findThis = self.settings.settings.plugins.cnc_gcodeviewer.skipUntilThis();
        ...
        var optionsLocalStorageKey = "core.cnc_gcodeviewer.options";
